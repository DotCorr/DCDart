...
END {
    ...
    print "  than a real allocator would. Under a decision that separates costs"
    print "  rather than merging them, this caveat is not optional: it goes next to"
    print "  the number, in the same voice as the trapping figure."
