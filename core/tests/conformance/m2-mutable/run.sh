...
# ---------------------------------------------------------------------------
# Step 3 — link main.c against mutable.o, freestanding. Same Linux/
...
if [[ $LINK_STATUS -ne 0 ]]; then
  cat "$LINK_LOG" >&2
  fail "freestanding link of main.c + mutable.o exited $LINK_STATUS (log above)"
fi
...
echo "M2-mutable: PASS — dcc build -> verify-freestanding pass -> freestanding link -> 400 scalar reassignment checks (straight-line + branch-scoped), all correct"
exit 0
