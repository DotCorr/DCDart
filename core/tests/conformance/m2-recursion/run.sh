...
# ---------------------------------------------------------------------------
# Step 3 — link main.c against recursion.o, freestanding. Same Linux/
...
if [[ $LINK_STATUS -ne 0 ]]; then
  cat "$LINK_LOG" >&2
  fail "freestanding link of main.c + recursion.o exited $LINK_STATUS (log above)"
fi
...
echo "M2-recursion: PASS — dcc build -> verify-freestanding pass -> freestanding link -> self-recursive calls (depth 0-60) with a heap object per stack frame, all correct and leak-free"
exit 0
