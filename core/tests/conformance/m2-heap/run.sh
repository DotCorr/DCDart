...
# ---------------------------------------------------------------------------
# Step 3 — link main.c against box.o, freestanding. Same Linux/x86-64-only
...
if [[ $LINK_STATUS -ne 0 ]]; then
  cat "$LINK_LOG" >&2
  fail "freestanding link of main.c + box.o exited $LINK_STATUS (log above)"
fi
...
echo "M2-heap: PASS — dcc build -> verify-freestanding pass -> freestanding link -> 1000 alloc/read/release cycles, leak-free"
exit 0
