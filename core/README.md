...
> **37 passed, 0 failed, 0 skipped on Darwin/arm64** (35 before ADR-0057 added the `closure`
> target and ADR-0054 added `generic-class`), but two things follow that the rows below do not
> say:
>
